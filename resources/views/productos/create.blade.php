...
@section('crud')
    <div class="flex flex-col w-full py-2 h-auto px-20">
        ...
        <div class="w-full mx-auto sm:px-6 lg:px-8 h-auto">
            ...
            <div class="w-auto bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg p-6 lg:p-8 h-full">
                ...
                <form method="POST" action="{{ route('productostore') }}" enctype="multipart/form-data" class="w-sm px-10">
                    ...
                    <div class="flex flex-row justify-center items-center text-center space-x-10 pt-5 w-full h-auto">
                        ...
                        <div class="w-full h-full flex flex-col space-y-4 justify-center items-center text-center">
                            <button type="submit"
