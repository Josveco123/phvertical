      ...
      <div class="collapse navbar-collapse" id="navbarText">
        @auth('admin')
          ...
          <ul class="navbar-nav side-nav" >
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{ route('admins.admins') }}" style="margin-left: 20px;">Administradores</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="{{ route('admins.hometypes') }}" style="margin-left: 20px;">Tipos de Propiedad</a>
            </li>
            <li class="nav-item">
        ...
        <ul class="navbar-nav ml-md-auto d-md-flex">
          ...
          @else
            <li class="nav-item">
              <a class="nav-link text-sm" href="{{ route('view.login') }}">login
              </a>
            </li>
          @endauth
