    ...
    <div class="slide-one-item home-slider owl-carousel">
        @foreach ($props as $prop)
            <div class="site-blocks-cover overlay"
                style="background-image: url({{ asset('public/storage/images/' . $prop->image) }});
                    ...
                    <div class="col-md-6 col-lg-4 mb-4">
                        <div class="property-entry h-100">
                            <a href="{{ route('single.prop', $prop->id) }}" class="property-thumbnail">
                                ...
                                <img src="{{ asset('public/storage/images/' . $prop->image) }}" alt="Image prop 1"
            ...
            <div class="row">
                <div class="col-md-6 col-lg-4 mb-5 mb-lg-5">
                    <div class="flex flex-col justify-center align-items-center  team-member mr-5">
                        <div
                            ...
                            <img src="{{ asset('public/storage/images/asesor1.jpeg') }}" alt="Image"
                ...
                <div class="col-md-6 col-lg-4 mb-5 mb-lg-5">
                    <div class="flex flex-col justify-center align-items-center  team-member mr-5">
                        <div
                            class="flex justify-center align-items-center p-1  border-2 border-gray-200 bg-gray-150 rounded-full w-3/5 h-64">
                            <img src="{{ asset('public/storage/images/asesor2.jpg') }}" alt="Image"
                                class="img-fluid rounded-full w-11/12">
                        </div>
                        <div class="text">
                ...
                <div class="col-md-6 col-lg-4 mb-5 mb-lg-5">
                    <div class="flex flex-col justify-center align-items-center  team-member mr-5">
                        ...
                        <div
                            class="flex justify-center align-items-center p-1  border-2 border-gray-200 bg-gray-150 rounded-full w-3/5 h-64">
                            <img src="{{ asset('public/storage/images/asesor3.jpg') }}" alt="Image"
                                class="img-fluid rounded-full w-11/12">
                        </div>
                        <div class="text">
