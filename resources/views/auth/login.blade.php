...
@section('content')
    <div class="grid grid-cols-1 lg:grid-cols-2  pt-5 lg:pt-16 px-20">
        <div class="flex flex-col justify-center items-center w-auto h-full  rounded-3xl bg-red-50 p-1 lg:p-2">
            ...
            <div class="text-gray-500 w-5/6 text-xs text-justify hidden lg:block p-1 lg:p-2 lg:flex flex-row lg:flex-row justify-center items-start">
                <span>
                    ...
                    <span class="text-gray-700"><i class="bi bi-house-door"></i> Registrandote dispones de dos herramientas en línea como son: <i class="bi bi-house-door"></i></span><br /><br />
                    ...
                    <div class="card-body text-sm lg:text-lg">
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="row mb-3 flex flex-col justify-center items-center">
                                <label for="email"
                                    class="col-md-8 col-form-label text-md-end">Correo electrónico</label>

                                <div class="col-md-8 text-sm">
                                    <input id="email" type="email"
                                        class="form-control @error('email') is-invalid @enderror" name="email"
                                        value="{{ old('email') }}" required autocomplete="email" autofocus oninput="this.value = this.value.toLowerCase();" style="height: 30px;">
                            ...
                            <div class="row mb-3 flex flex-col justify-center items-center">
                                <label for="password"
                                    class="col-md-8 col-form-label text-md-end">Clave</label>
