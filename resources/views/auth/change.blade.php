                    ...
                    @endif
                        ...
                        <form method="POST" action="{{ route('change.password') }}">
                            ...
                            <div class="row mb-2 flex flex-col justify-center items-center">
                                ...
                                <div class="col-md-8">
                                    <input type="password" class="form-control @error('password') is-invalid @enderror" name="current_password" required autocomplete="new-password"  style="height:30px;">
                            ...
                            <div class="row mb-2 flex flex-col justify-center items-center">
                                ...
                                <div class="col-md-8">
                                    <input type="password" class="form-control @error('password') is-invalid @enderror" name="new_password" required autocomplete="new-password"  style="height:30px;">
                            ...
                            <div class="row mb-2 flex flex-col justify-center items-center">
                                ...
                                <div class="col-md-8">
                                    <input type="password" class="form-control @error('password') is-invalid @enderror" name="new_password_confirmation" required autocomplete="new-password"  style="height:30px;">
