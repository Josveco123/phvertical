...
<div class="site-blocks-cover inner-page-cover overlay" style="background-image: url({{ asset('public/storage/images/hero_bg_2.jpg') }});" data-aos="fade">
    <div class="container">
      <div class="row align-items-center justify-content-center text-center">
        <div class="col-md-10">
          <h1 class="mb-2">Propiedades por precio ascendentepo</h1>
      ...
      <div class="row">
        <div class="col-12">
          <div class="site-section-title mb-5">
            <h2>propiedades por precio desendente</h2>
          </div>
        </div>
      </div>
        ...
        @if ($propsByPriceAsc->count() > 0)
            ...
            <div class="col-md-6 col-lg-4 mb-4">
                ...
                <a href="{{ route('single.prop', $relatedProp->id) }}" class="property-thumbnail">
                    ...
                    <img src="{{ asset('public/storage/images/'.$relatedProp->image) }}" alt="Image" class="img-fluid">
                </a>
            ...
            @endforeach
        @else
            <h3 class="alert alert-success">No hay propiedades para este tipo de casa en este momento.</h3>
        @endif
